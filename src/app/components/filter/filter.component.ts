...
import { IonList, IonItem,  IonAccordion, IonAccordionGroup, IonLabel, IonTitle, 
   IonHeader, IonContent } from '@ionic/angular/standalone';
...
@Component({
  ...
  standalone: true,
  imports: [IonHeader, IonTitle, IonLabel, IonAccordionGroup, IonAccordion, 

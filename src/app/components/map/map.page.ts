...
import {IonGrid, IonRow,  IonToolbar, IonTitle, IonContent, IonSearchbar, IonCard, IonCardHeader } from '@ionic/angular/standalone';
...
@Component({
  ...
  imports: [IonGrid, IonRow,  IonSearchbar, IonToolbar, IonTitle, IonContent, 
    IonCard, IonContent, GoogleMapsModule, CommonModule],
